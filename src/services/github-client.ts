...
export function getGitHubClientTest(client?: Partial<Effect.Effect.Success<typeof githubClient>>) {
    return Layer.succeed(
        ...
        GithubClient.of({
            ...
            compareToCurrentDeployCommit: getTestResponse('compareCommitsWithBasehead'),
            listCommits: getTestResponse('listCommits'),
            listPullRequestsAssociatedWithCommit: getTestResponse(
...
const defaultTestResponses = {
    ...
    } satisfies RestEndpointMethodTypes['repos']['compareCommits']['response'],
    listCommits: {
    ...
    } satisfies RestEndpointMethodTypes['repos']['listCommits']['response'],
    listPullRequestsAssociatedWithCommit: {
        url: 'https://api.github.com/repos/octocat/Hello-World/commits',
        status: 200,
        headers: {},
    ...
    } satisfies RestEndpointMethodTypes['repos']['listPullRequestsAssociatedWithCommit']['response'],
}
